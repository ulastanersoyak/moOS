...
int32_t isdigit(int32_t c) { return (c >= 48 && c <= 57) ? 0 : 1; }

int32_t isgraph(int32_t c) { return (c >= 33 && c <= 126) ? 0 : 1; }

int32_t islower(int32_t c) { return (c >= 97 && c <= 122) ? 0 : 1; }

int32_t isprint(int32_t c) { return (c >= 33 && c <= 126) ? 0 : 1; }
...
int32_t isspace(int32_t c) { return c == 32 ? 0 : 1; }

int32_t isupper(int32_t c) { return (c >= 65 && c <= 90) ? 0 : 1; }
